...
const features = [
		...
		figure: (
			<ImageLink href="https://react-styleguidist.js.org/examples/basic/">
				<img
					...
					alt="React Styleguidist example style guide"
				/>
			</ImageLink>
		),
	},
			...
			<Row>
				<Column size={6}>
					<ImageLink href="https://cdds.netlify.app/styleguide/">
						<img
							src="/img/styleguide1.jpg"
							alt="Component-driven.io style guide"
						/>
					</ImageLink>
				</Column>
				<Column size={6}>
	...
	},
	{
		...
		subtitle:
			'See how components react to different props and data right in the browser',
		paragraphs: ['Find the right combination of props and copy the code'],
		figure: (
			<ImageLink
				href="https://react-kawaii.now.sh/"
				className={styles.featureFigureKawaii}
			>
