...
import Markdown from '../src/rsg-components/Markdown';
...
`;
		let expected = `
<span class="_src_rsg_components_Markdown_Markdown__root _src_styles_common__reset _src_styles_common__font">
