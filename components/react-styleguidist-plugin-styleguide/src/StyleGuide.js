...
import TableOfContents from 'react-styleguidist-plugin-tableofcontents';
import StyleGuideRenderer	from './StyleguideRenderer';
import Sections from 'react-styleguidist-plugin-sections';
import Welcome from 'react-styleguidist-plugin-welcome';
import Error from 'react-styleguidist-plugin-error';
import DisplayModes, { links } from 'react-styleguidist-common';

const { HOMEPAGE } = links;

/**
 * This function will return true, if the sidebar should be visible and false
 * otherwise.
 *
		...
		return (
			<StyleGuideRenderer
				...
				toc={<TableOfContents sections={allSections}
															useIsolatedLinks={pagePerSection}/>}
