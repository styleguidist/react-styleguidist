...
var StyleGuide = function (_Component) {
	...
	function StyleGuide() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StyleGuide.__proto__ || Object.getPrototypeOf(StyleGuide)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			listMode: _this.props.listTypes[0] }, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(StyleGuide, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    listTypes = _props.listTypes,
			    welcomeScreen = _props.welcomeScreen,
			    patterns = _props.patterns,
			    isolatedComponent = _props.isolatedComponent;
			var searchTerm = this.state.searchTerm;

			var list = sections.length === 1 ? sections : sections.filter(function (section) {
				return section.name === _this2.state.listMode;
			})[0].sections;
			var filteredSections = searchTerm ? (0, _utils.filterSectionsByName)(list, searchTerm) : list;
			...
			return _react2.default.createElement(
				_StyleGuideRenderer2.default,
				{
					...
					listTypes: listTypes,
					onListToggle: function onListToggle(listMode) {
						return _this2.setState({ listMode: listMode });
					},
