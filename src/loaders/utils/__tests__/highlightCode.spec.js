...
it('should warn when language not found', () => {
	...
	expect(warn).toBeCalledWith(
		'Syntax highlighting for “pizza” isn’t supported. Supported languages are: clike, markup, xml, html, mathml, svg, markdown, css, scss, javascript, js, flow, typescript, ts, jsx, tsx, graphql, json, jsonp, bash, shell.'
	);
});
